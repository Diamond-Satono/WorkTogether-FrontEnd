<template>
    <div id="sidebar">
      ...
      <ul>
        ...
        <li id="calendar">
          <i class="fas fa-file"></i>  
          <a style="color: #ff7f50;" @click="toggleSubMenu('calendar')"><fa icon="folder-open" /> 日历</a>
          <ul class="submenu" v-show="subMenuStatus.calendar">
            <li><a><fa icon="file" />  1</a></li>
          </ul>
        </li>
        <li id="settings">
          <i class="fas fa-file"></i>  
          <a @click="toggleSubMenu('settings')"><fa icon="folder-open" />  设置</a>
        ...
        <li id="userinfo">
          <i class="fas fa-file"></i>  
          <a @click="toggleSubMenu('userinfo')"><fa icon="folder-open" />  个人信息</a>
        ...
        <li id="tasks">
          <i class="fas fa-file"></i>  
          <a @click="toggleSubMenu('tasks')"><fa icon="folder-open" />  任务管理</a>
      ...
      <div id="group-change">
        ...
        <button id="user-button2" @click="toggleMenu2"><img id="change-icon" src="@/assets/img/group_change.png" alt="Icon"></button>
      </div>
...
/*     margin-left: 250px; */
  ...
  #group-bubble{
    ...
    align-items: center;
    box-shadow: 0 0 20px rgba(0, 0, 0, 0.2); /* 四周阴影 */
  }
  .bubble-menu2 {
    position:absolute;
    z-index: 1000; /* 确保菜单在顶层显示 */

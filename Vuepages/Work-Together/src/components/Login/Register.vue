<template>
  <div class="background">
    ...
    <div class="steps">
      ...
      <div class="step1">
        <div class="firststep">
          <img class="step1pic" src="@/assets/loginimgs/stepselecting.svg" />邮箱验证
        </div>
      ...
      <div class="step2">
        <div class="secondstep">
          <img
            class="step2pic"
            src="@/assets/loginimgs/stepunselected.svg"
          />输入/确认密码
        </div>
        <img src="@/assets/loginimgs/greylink.png" class="link2" />
      </div>
      <!-- 第三步 -->
      <div class="step3">
        <div class="thirdstep">
        ...
        <img src="@/assets/loginimgs/greylink.png" class="link3" />
      </div>
      <!-- 第四步 -->
      <div class="step4">
    ...
    <div class="Registerbackground">
      ...
      <!-- 第一步内容 -->
      <div class="STEPONE">
        <div class="steptitle1">步骤1/4</div>
        <div class="stepname1">验证你的邮箱</div>
        <!-- 输入邮箱 -->
        <div class="emailtitle">
          <img
            src="@/assets/loginimgs/LoginMail.svg"
